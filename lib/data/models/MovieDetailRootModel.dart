...
MovieDetailRootModel movieDetailRootModelFromJson(String str) => MovieDetailRootModel.fromJson(json.decode(str));

String movieDetailRootModelToJson(MovieDetailRootModel data) => json.encode(data.toJson());
...
class MovieDetailRootModel {
  ...
  factory MovieDetailRootModel.fromJson(Map<String, dynamic> json) => MovieDetailRootModel(
    adult: json["adult"],
